...
--
-- For example, in the folke/which-key.nvim, we use:
--  event = 'VimEnter'
--
...
require("lazy").setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require("telescope").setup({
        ...
        pickers = {
          find_files = {
            ...
            -- (GJ) also include gitignored files (eg. scripts in /Library for Unity projects, or source code in /node_modules in JS projects)
            -- commented because it affects performance, should do it explicitly via keymap (see <leader>sF and <leader>sG)
            -- no_ignore = true,
          },
        },
      ...
      end, { desc = "[S]earch by [G]rep (DEEP)" })
...

  {
    ...
    config = function()
      ...
      -- These Language Servers are standalone processes that communicate with some "client" - in this case, Neovim!
      --
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          -- (GJ) changed keymapping from gO to gro, cuz im always on gr- anyways for other LSP stuff
          map("gro", require("telescope.builtin").lsp_document_symbols, "[O]pen Document Symbols")

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          -- (GJ) changed keymapping from gW to grw
      ...
      -- (GJ) seems to be suggested for HTML/CSS setup
